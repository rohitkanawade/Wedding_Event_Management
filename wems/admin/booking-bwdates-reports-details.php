...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        <title>Onlind Wedding Event Management Sysyem - B/W Dates Booking Report</title>
...
{               ?>
                                    <tr>
                                        ...
                                        <td class="font-w620"><?php  echo htmlentities($row->BookingID);?></td>
                                        <td class="font-w620"><?php  echo htmlentities($row->FullName);?></td>
                                        <td class="font-w620"><?php  echo htmlentities($row->MobileNumber);?></td>
                                        <td class="font-w620"><?php  echo htmlentities($row->Email);?></td>
                                        <td class="font-w620">
                                            <span class="badge badge-primary"><?php  echo htmlentities($row->BookingDate);?></span>
                                        </td>
                                        <?php if($row->Status==""){ ?>

                     <td class="font-w620"><?php echo "Not Updated Yet"; ?></td>
<?php } else { ?>
