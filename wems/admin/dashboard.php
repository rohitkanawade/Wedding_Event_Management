<!doctype html>
 ...
 <head>
 <title>Wedding Event Management Sysyem - Admin Dashboard</title>
...
?>
                                    ...
                                    <p class="font-w620 text-white">Total Unread Queries</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-6 col-md-4 col-xl-3">
...
?>
                                    ...
                                    <p class="font-w620 text-white">Total Read Queries</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-6 col-md-4 col-xl-3">
...
?>
                                    ...
                                    <p class="font-w620 text-white">Total New Booking</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-6 col-md-4 col-xl-3">
...
?> 
                                    ...
                                    <p class="font-w620 text-white">Total Approved Booking</p>
                                </div>
                            </a>
                        </div>
...
?>
                                    ...
                                    <p class="font-w620 text-white">Total Cancelled Booking</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-6 col-md-4 col-xl-4">
...
?>
                                    ...
                                    <p class="font-w620 text-white">Total Services</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-6 col-md-4 col-xl-4">
...
?>
                                    ...
                                    <p class="font-w620 text-white">Total Event Type</p>
                                </div>
                            </a>
                        </div>
