...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>       
        <title>Online Wedding Event Management Sysyem - Forgot Page</title>
                    ...
                    <div class="row mx-0 bg-black-op">
                        <div class="hero-static col-md-6 col-xl-8 d-none d-md-flex align-items-md-end">
                            <div class="p-30 invisible" data-toggle="appear">
                                <p class="font-size-h3 font-w620 text-white">
                                    Wedding Event Management Sysyem.
                                </p>
                            ...
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    <a class="link-effect font-w700" href="login.php">
                                        ...
                                        <span class="font-size-xl">WEMS</span>
                                    </a>
